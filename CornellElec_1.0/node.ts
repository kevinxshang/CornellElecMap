...
const shadeMap = new Simulator({
    apiKey: "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6ImN1Z2VvZGF0YS5kYXRhQGdtYWlsLmNvbSIsImNyZWF0ZWQiOjE3MjIyNzYyMTg2MzUsImlhdCI6MTcyMjI3NjIxOH0.wagUL8tODh-Sf7x83ulXFtrMK62v1RE2GskjJ1MKr1I",
    date: now,
    color: '#01112f',
    opacity: 0.7,
    terrainSource: {
